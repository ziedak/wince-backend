...
// ? this service is responsible for generating and persisting discount codes for interventions
// ? currently used only for dev need to be extended to support production woocommerce/shopify discount codes
//TODO: check how woocommerce/shopify handles discount codes,
//       and if we can use their format instead of our own
